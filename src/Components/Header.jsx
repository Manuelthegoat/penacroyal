      ...
      <div class="navbar-left">
        <div class="logo-area">
          <a class="navbar-brand" href="index-2.html">
            {/* <img class="dark logos" src="img/4.jpg" alt="logo" />
            <img class="light logos" src="img/4.jpg" alt="logo" /> */}
            <h4 className="dark">Penac Royal</h4>
          </a>
            ...
            <ul class="d-flex align-items-center flex-wrap">
              ...
              <li class="has-subMenu">
                ...
                <ul class="subMenu">
                  ...
                  <li class="layout">
                    <a href="https://demo.dashboardmarket.com/hexadash-html/ltr">
                      LTR
                    </a>
                  </li>
                </ul>
                  ...
                  <li>
                    <ul>
                      <li class="has-subMenu-left">
                        ...
                        <ul class="subMenu">
                          <li>
                            <a href="inbox.html" class>
                              Inbox
                            </a>
                          </li>
                          <li>
                            <a href="read-email.html" class>
                              Read Email
                            </a>
                          </li>
                        </ul>
                      ...
                      <li class="has-subMenu-left">
                        ...
                        <ul class="subMenu">
                          ...
                          <li>
                            <a href="sellers.html" class>
                              Sellers
                            </a>
                          </li>
                          <li>
                            <a href="invoice.html" class>
                              Invoices
                            </a>
                          </li>
                        </ul>
                      ...
                      <li class="has-subMenu-left">
                        ...
                        <ul class="subMenu">
                          <li>
                            <a href="users-membar.html" class>
                              Team
                            </a>
                          </li>
                          <li>
                            <a href="users-card.html" class>
                              Users Grid
                            </a>
                          </li>
                          <li>
                            <a href="users-list.html" class>
                              Users List
                            </a>
                          </li>
                          <li>
                            <a href="users-card2.html" class>
                              Users Grid style
                            </a>
                          </li>
                          <li>
                            <a href="users-group.html" class>
                              Users Group
                            </a>
                          </li>
                          <li>
                      ...
                      <li class="has-subMenu-left">
                        ...
                        <ul class="subMenu">
                          <li>
                            <a class href="contact-1.html">
                              Contact 1
                            </a>
                          </li>
                          <li>
                            <a class href="contact-2.html">
                              Contact 2
                            </a>
                          </li>
                        </ul>
                  ...
                  <li>
                    <ul>
                      ...
                      <li class="has-subMenu-left">
                        ...
                        <ul class="subMenu">
                          <li>
                            <a class href="import.html">
                              Import
                            </a>
                          </li>
                          <li>
                            <a class href="export.html">
                              Export
                            </a>
                          </li>
                          <li>
                      ...
                      <li class="has-subMenu-left">
                        ...
                        <ul class="subMenu">
                          <li>
                            <a class href="support-ticket.html">
                              Support Ticket
                            </a>
                          </li>
                          <li>
                            <a class href="support-details.html">
                              Ticket Details
                            </a>
                          </li>
                          <li>
                            <a class href="new-ticket.html">
                              New Ticket
                            </a>
                          </li>
                        </ul>
                      ...
                      <li class="has-subMenu-left">
                        ...
                        <ul class="subMenu">
                          <li>
                            <a class href="jobSearch.html">
                              Grid view
                            </a>
                          </li>
                          <li>
                            <a class href="jobSearchList.html">
                              List View
                            </a>
                          </li>
                          <li>
                            <a class href="jobDetails.html">
                              Details
                            </a>
                          </li>
                          <li>
                            <a class href="job-apply.html">
                              Apply
                            </a>
                          </li>
                        </ul>
                      ...
                      <li class="has-subMenu-left">
                        ...
                        <ul class="subMenu">
                          <li>
                            <a href="basic-table.html" class>
                              Basic Table
                            </a>
                          </li>
                          <li>
                            <a href="datatable.html" class>
                              Data Table
                            </a>
                          </li>
                          <li>
              ...
              <li class="has-subMenu">
                ...
                <ul class="subMenu">
                  <li class="has-subMenu-left">
                    ...
                    <ul class="subMenu">
                      <li>
                        <a class href="firestore.html">
                          View All
                        </a>
                      </li>
                      <li>
                        <a class href="firestore-add.html">
                          Add New
                        </a>
                      </li>
                    </ul>
              ...
              <li class="has-subMenu">
                ...
                <ul class="subMenu">
                  ...
                  <li class="has-subMenu-left">
                    ...
                    <ul class="subMenu">
                      <li>
                        <a href="unicon-icons.html" class>
                          Unicon Icons
                        </a>
                      </li>
                      <li>
                        <a href="fontawesome.html" class>
                          Font Awesome
                        </a>
                      </li>
                      <li>
                        <a href="lineawesome.html" class>
                          Line Awesome
                        </a>
                      </li>
                    </ul>
                  ...
                  <li class="has-subMenu-left">
                    ...
                    <ul class="subMenu">
                      ...
                      <li>
                        <a class href="google-chart.html">
                          Google Charts
                        </a>
                      </li>
                      <li>
                        <a class href="peity-chart.html">
                          Peity Charts
                        </a>
                      </li>
                    </ul>
                  ...
                  <li class="has-subMenu-left">
                    ...
                    <ul class="subMenu">
                      ...
                      <li>
                        <a class href="form-layouts.html">
                          Layouts
                        </a>
                      </li>
                      <li>
                        <a class href="form-elements.html">
                          Elements
                        </a>
                      </li>
                      <li>
                        <a class href="form-components.html">
                          Components
                        </a>
                      </li>
                      <li>
                  ...
                  <li class="has-subMenu-left">
                    ...
                    <ul class="subMenu">
                      <li>
                        <a href="google-map.html" class>
                          Google Maps
                        </a>
                      </li>
                      <li>
                        <a href="leaflet-map.html" class>
                          Leaflet Maps
                        </a>
                      </li>
                      <li>
                        <a href="vector-map.html" class>
                          Vector Maps
                        </a>
                      </li>
                    </ul>
                  ...
                  <li class="has-subMenu-left">
                    ...
                    <ul class="subMenu">
                      <li>
                        <a class href="widget-charts.html">
                          Chart
                        </a>
                      </li>
                      <li>
                        <a class href="widget-mixed.html">
                          Mixed
                        </a>
                      </li>
                      <li>
                  ...
                  <li class="has-subMenu-left">
                    ...
                    <ul class="subMenu">
                      <li>
                        <a href="checkout-wizard6.html" class>
                          Wizard 1
                        </a>
                      </li>
                      <li>
                        <a href="checkout-wizard7.html" class>
                          Wizard 2
                        </a>
                      </li>
                      <li>
                        <a href="checkout-wizard8.html" class>
                          Wizard 3
                        </a>
                      </li>
                      <li>
                        <a href="checkout-wizard9.html" class>
                          Wizard 4
                        </a>
                      </li>
                      <li>
                        <a href="checkout-wizard10.html" class>
                          Wizard 5
                        </a>
                      </li>
                    </ul>
                ...
                <ul class="megaMenu-wrapper megaMenu-small">
                  ...
                  <li>
                    <ul>
                      ...
                      <li>
                        <a href="course.html" class>
                          Course
                        </a>
                      </li>
                      <li>
                        <a href="course-details.html" class>
                          Course Details
                        </a>
                      </li>
                      <li>
              ...
              <li class="mega-item has-subMenu">
                ...
                <ul class="megaMenu-wrapper megaMenu-wide">
                  <li>
                    ...
                    <ul>
                      <li>
                        <a class href="alert.html">
                          Alert
                        </a>
                      </li>
                      <li>
                        <a class href="avatar.html">
                          Avatar
                        </a>
                      </li>
                      <li>
                        <a class href="badge.html">
                          Badge
                        </a>
                      </li>
                      <li>
                        <a class href="breadcrumbs.html">
                          Breadcrumb
                        </a>
                      </li>
                      <li>
                        <a class href="buttons.html">
                          Button
                        </a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a class href="carousel.html">
                          Carousel
                        </a>
                      </li>
                      <li>
                        <a class href="checkbox.html">
                          Checkbox
                        </a>
                      </li>
                      <li>
                        <a class href="collapse.html">
                          Collapse
                        </a>
                      </li>
                      <li>
                        <a class href="comments.html">
                          Comments
                        </a>
                      </li>
                    </ul>
                  ...
                  <li>
                    ...
                    <ul>
                      ...
                      <li>
                        <a class href="date-picker.html">
                          DatePicker
                        </a>
                      </li>
                      <li>
                        <a class href="drawer.html">
                          Drawer
                        </a>
                      </li>
                      <li>
                        <a class href="drag-drop.html">
                          Drag & Drop
                        </a>
                      </li>
                      <li>
                        <a class href="dropdown.html">
                          Dropdown
                        </a>
                      </li>
                      <li>
                        <a class href="empty.html">
                          Empty
                        </a>
                      </li>
                      <li>
                        <a class href="input.html">
                          Input
                        </a>
                      </li>
                      <li>
                  ...
                  <li>
                    ...
                    <ul>
                      ...
                      <li>
                        <a class href="page-header.html">
                          Page Headers
                        </a>
                      </li>
                      <li>
                        <a class href="pagination.html">
                          Paginations
                        </a>
                      </li>
                      <li>
                        <a class href="progressbar.html">
                          Progress
                        </a>
                      </li>
                      <li>
                        <a class href="radio.html">
                          Radio
                        </a>
                      </li>
                      <li>
                        <a class href="rate.html">
                          Rate
                        </a>
                      </li>
                      <li>
                        <a class href="result.html">
                          Result
                        </a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a class href="skeleton.html">
                          Skeleton
                        </a>
                      </li>
                      <li>
                        <a class href="time-picker.html">
                          Timepicker
                        </a>
                      </li>
                    </ul>
                  ...
                  <li>
                    ...
                    <ul>
                      <li>
                        <a class href="slider.html">
                          Slider
                        </a>
                      </li>
                      <li>
                        <a class href="spin.html">
                          Spinner
                        </a>
                      </li>
                      <li>
                        <a class href="statistics.html">
                          Statistic
                        </a>
                      </li>
                      <li>
                        <a class href="steps.html">
                          Steps
                        </a>
                      </li>
                      <li>
                        <a class href="switch.html">
                          Switch
                        </a>
                      </li>
                      <li>
                        <a class href="tab.html">
                          Tabs
                        </a>
                      </li>
                      <li>
                        <a class href="tag.html">
                          Tags
                        </a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a class href="timeline-2.html">
                          Timeline 2
                        </a>
                      </li>
                      <li>
                        <a class href="timeline-3.html">
                          Timeline 3
                        </a>
                      </li>
                      <li>
                        <a class href="uploads.html">
                          Upload
                        </a>
                      </li>
                    </ul>
                ...
                <div class="dropdown-wrapper">
                  ...
                  <div class="nav-author__options">
                    <ul>
                      ...
                      <li>
                        <a href>
                          <i class="uil uil-key-skeleton"></i> Billing
                        </a>
                      </li>
                      <li>
                        <a href>
                          <i class="uil uil-users-alt"></i> Activity
                        </a>
                      </li>
                      <li>
                        <a href>
